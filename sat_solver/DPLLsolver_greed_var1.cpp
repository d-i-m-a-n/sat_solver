...
void DPLLsolver_greed_var1::createKNFfromDIMACS(const std::string& DIMACS_filepath)
{
...
bool DPLLsolver_greed_var1::backTrackAlg() 
{
	/*
...
bool DPLLsolver_greed_var1::chooseVarAlg()
{
	int maxWeight = 0;
	int choosenVar = -1;
	/*
...
bool DPLLsolver_greed_var1::deduceAlg()
{
	/*
...
bool DPLLsolver_greed_var1::deduceM1(BoolMatrix& M1_, BoolMatrix& bufM1_, BoolVector& V1_, BoolMatrix& M0_, BoolMatrix& bufM0_, BoolVector& V0_, BoolVector& stackV, bool& changes)
{
