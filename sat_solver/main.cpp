...
int main()
{
	...
	std::filesystem::path sat_tests_dp2 = std::filesystem::current_path() / "test" / "II";
	// ������ �����������
	...
	run_single_test_CDCL_opt(cdcl_solver_opt, sat_tests_dp2, "./TESTS_RESULT/SAT_TESTS_cdcl_solver_optimized2.txt", true);
	run_test_CDCL_opt(cdcl_solver_opt, sat_tests_dp, "./TESTS_RESULT/SAT_TESTS_cdcl_solver_optimized2.txt", true);
